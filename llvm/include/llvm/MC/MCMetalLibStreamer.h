//===- MCMetalLibStreamer.h - MCMetalLibStreamer Interface ------*- C++ -*-===//
//
...
// Metal `.metallib` container is an opaque, monolithic blob produced by the
// Metal target's embedder pass; the streamer just routes its bytes through
// to the MetalLibObjectWriter.
//
//===----------------------------------------------------------------------===//
...
/// `MCObjectStreamer` for the MetalLib container.
///
...
#endif // LLVM_MC_MCMETALLIBSTREAMER_H
