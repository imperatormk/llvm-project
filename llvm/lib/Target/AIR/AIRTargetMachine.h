//===- AIRTargetMachine.h - AIR Target Implementation -------*- C++ -*-===//
//
...
class AIRTargetMachine : public CodeGenTargetMachineImpl {
  std::unique_ptr<TargetLoweringObjectFile> TLOF;
  std::unique_ptr<AIRSubtarget> Subtarget;
...
public:
  ...
  const AIRSubtarget *getSubtargetImpl(const Function &) const override;
...
#endif // LLVM_LIB_TARGET_AIR_AIRTARGETMACHINE_H
