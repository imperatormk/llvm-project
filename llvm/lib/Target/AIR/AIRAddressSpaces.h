//===- AIRAddressSpaces.h - AIR address-space constants -----*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_AIR_AIRADDRESSSPACES_H
#define LLVM_LIB_TARGET_AIR_AIRADDRESSSPACES_H
...
#endif // LLVM_LIB_TARGET_AIR_AIRADDRESSSPACES_H
