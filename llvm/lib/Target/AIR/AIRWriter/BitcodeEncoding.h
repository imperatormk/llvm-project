...
#ifndef LLVM_LIB_TARGET_AIR_AIRWRITER_BITCODEENCODING_H
#define LLVM_LIB_TARGET_AIR_AIRWRITER_BITCODEENCODING_H
...
#endif // LLVM_LIB_TARGET_AIR_AIRWRITER_BITCODEENCODING_H
