//===- AIRConstraints.h - AIR type constraints --------------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_AIR_AIRWRITER_AIRCONSTRAINTS_H
#define LLVM_LIB_TARGET_AIR_AIRWRITER_AIRCONSTRAINTS_H

/// AIR GPU constraints by address space and context.
///
...
// ── AIR type constraints ────────────────────────────────────────────────

/// AIR has no double, no i1 in memory, no float8.
...
struct AIRConstraints {
  ...
  /// Per AIR Shading Language Specification v3.2, threadgroup memory is
...
#endif // LLVM_LIB_TARGET_AIR_AIRWRITER_AIRCONSTRAINTS_H
